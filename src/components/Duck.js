export default class Duck {
    ...
    changePositionOfDuck(deltaTime) {
        let speedMultiplier = this.game.settings.duckSpeedMultiplier || 1;
        let changeXpos = deltaTime / 6 * this.duckSpeed * speedMultiplier * this.directionX;
        let changeYpos = deltaTime / 6 * this.duckSpeed * speedMultiplier * this.directionY;
